---
type: Guide
title: 소프트웨어 개발보안 가이드(2021) 제5장 — 부록
description: 설계단계 보안설계 기준 20개 원문, 구현단계 보안약점 제거 기준 49개 정의, 적용계획서·산출물 예시, 용어정리. 원문 341~375쪽의 마크다운 변환본.
resource: 소프트웨어 개발보안 가이드(2021)
status: stable
tags: [개발보안, 시큐어코딩, 행정안전부, kisa, 보안설계기준, 보안약점, 용어정리]
