...
* [SEED Design 재설계 구현 계획](superpowers/plans/2026-08-31-seed-design-redesign.md) - 위 명세를 React 19.2·Vite 8 앱에 적용하는 테스트 우선 실행 계획. Task 5개와 검증 스텝, 구현 결과 스크린샷(`superpowers/assets/seed-redesign/qa/`)을 담는다.
